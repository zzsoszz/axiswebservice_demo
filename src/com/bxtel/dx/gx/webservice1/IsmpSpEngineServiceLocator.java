...
public class IsmpSpEngineServiceLocator extends org.apache.axis.client.Service implements com.bxtel.dx.gx.webservice1.IsmpSpEngineService {
    ...
    public com.bxtel.dx.gx.webservice1.IsmpSpEngine_PortType getIsmpSpEngine() throws javax.xml.rpc.ServiceException {
    ...
    public com.bxtel.dx.gx.webservice1.IsmpSpEngine_PortType getIsmpSpEngine(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bxtel.dx.gx.webservice1.IsmpSpEngineSoapBindingStub _stub = new com.bxtel.dx.gx.webservice1.IsmpSpEngineSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bxtel.dx.gx.webservice1.IsmpSpEngine_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bxtel.dx.gx.webservice1.IsmpSpEngineSoapBindingStub _stub = new com.bxtel.dx.gx.webservice1.IsmpSpEngineSoapBindingStub(new java.net.URL(IsmpSpEngine_address), this);
                _stub.setPortName(getIsmpSpEngineWSDDServiceName());
                return _stub;
            }
        }
